...
public class PostoView {
    ...
    public PostoView() {
        ...
        menu5 += "1 - Etanol (R$ 3,59);\n";
        menu5 += "2 - Gasolina comum (R$ 8,49);\n";
        menu5 += "3 - Gasolina Aditivada (R$ 4,69);\n";
        menu5 += "4 - Diesel (R$ 2,89);\n";
        menu5 += "5 - Voltar;";

        menu6 += "Escolha uma opção:\n";
        menu6 += "1 - Ducha Ecológica (R$ 18,00)\n";
        menu6 += "2 - Troca de óleo (R$ 160,00)\n";
        menu6 += "3 - Balanceamento (R$ 95,00)\n";
        menu6 += "4 - Café (R$ 5,00)\n";
        menu6 += "5 - Voltar;";
